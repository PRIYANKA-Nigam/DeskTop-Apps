...
public class walkIn extends JFrame {
	...
	public walkIn() {
		...
		scrollPane.setBounds(0, 359, 1103, 160);
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String r = "Name : "+textField.getText().toString() +
						"|  Age :"+textField_4.getText().toString()+
						"| Gender :"+gen+ 
						"|  Prescription : "+comboBox.getSelectedItem()+
						"|  SYMPTOMS :"+textField_2.getText()+
						"|  Remark :"+textArea.getText()+
						"|  Date :"+spinner.getValue().toString();
				mod.addElement(r);
			}
		});
		...
		spinner.setBounds(74, 274, 142, 20);
		...
		panel_1_1.setBounds(0, 557, 1103, 29);
		...
		btnNewButton_1.setBounds(472, 530, 89, 23);
